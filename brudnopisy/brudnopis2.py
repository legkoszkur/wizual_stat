...
class DifferentationMeasures:#todo tutuaj będzie okienko do tworzenia wykresów
    def __init__(self, master,data):
        ...
        self.ch_b1 = tk.Checkbutton(self.differ_lf, text="Standard deviation", variable=self.ch1,
                                    onvalue="Standard deviation",tristatevalue=0, )
        self.ch_b2 = tk.Checkbutton(self.differ_lf, text="Coefficient of variation", variable=self.ch2,
                                    onvalue="Coefficient of variation", tristatevalue=0, )
        self.ch_b3 = tk.Checkbutton(self.differ_lf, text="Range", variable=self.ch3, onvalue="Range", tristatevalue=0,)
        self.ch_b4 = tk.Checkbutton(self.differ_lf, text="Interquartile range", variable=self.ch4,
                                    onvalue="Interquartile range", tristatevalue=0, )
        self.ch_b5 = tk.Checkbutton(self.differ_lf, text="Quarter deviation", variable=self.ch5,
