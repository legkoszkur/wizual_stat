...
input_statistics_list_one = ['Sum', 'Mean', 'Min', 'Max',]
input_statistics_list_two = ['Sum', 'Mean']
...
class StatisticBackend:
    def __init__(self, data, input_var,input_stat, wish,):
        ...
        if self.wish == 0:
            ...
            print(self.average_measures_df)
        elif self.wish == 1:
            for i in self.input_var:
...
check = StatisticBackend(data, input_variables,input_statistics_list_one,0)
